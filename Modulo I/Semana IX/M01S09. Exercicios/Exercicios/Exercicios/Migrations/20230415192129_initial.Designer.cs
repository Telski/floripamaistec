...
namespace Exercicios.Migrations
{
    ...
    [Migration("20230415192129_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exercicios.Models.Bebe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Exercicios.Models.Mae", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Exercicios.Models.Medico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Exercicios.Models.Parto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Exercicios.Models.Bebe", b =>
                {
                    b.HasOne("Exercicios.Models.Mae", "Mae")
                        .WithMany("Bebes")
                        .HasForeignKey("MaeId")
                        .IsRequired()
                        .HasConstraintName("FK__Mae_Bebe");

                    b.HasOne("Exercicios.Models.Parto", "Parto")
                        .WithMany("Bebes")
            ...
            modelBuilder.Entity("Exercicios.Models.Parto", b =>
                {
                    b.HasOne("Exercicios.Models.Medico", "Medico")
                        .WithMany("Partos")
